...
namespace TeleopReachy
{
    ...
    public class Signaling
    {
        ...
        public UnityEvent<WebRTCConnectionStatus> event_OnConnectionStatus;
        ...
        public Signaling(string url, bool producer, string remote_producer_name = "")
        {
            ...
            event_OnConnectionStatus = new UnityEvent<WebRTCConnectionStatus>();
            ...
            webSocket.OnMessage += (bytes) =>
            {
                ...
                if (message != null)
                {
                    ...
                    {
                        _peer_id = msg.peerId;
                        event_OnConnectionStatus.Invoke(WebRTCConnectionStatus.Waiting);
                    ...
                    else if (msg.type == MessageType.StartSession.ToString())
                    {
                        ...
                        event_OnConnectionStatus.Invoke(WebRTCConnectionStatus.Ready);
                    }
